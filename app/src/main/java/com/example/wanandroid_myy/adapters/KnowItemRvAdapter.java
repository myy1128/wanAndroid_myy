...
public class KnowItemRvAdapter extends RecyclerView.Adapter<KnowItemRvAdapter.ViewHolder> {
    private ArrayList<KnowItemBean.DatasBean> list;
    private Context context;

    public KnowItemRvAdapter(ArrayList<KnowItemBean.DatasBean> list, Context context) {
        this.list = list;
    ...
    public interface OnClickListener{
        void OnItemClick(int p, KnowItemBean.DatasBean datasBean);
    }
}
